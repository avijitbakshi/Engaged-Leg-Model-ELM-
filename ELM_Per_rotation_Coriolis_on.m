...
slopetaurange=0:50:1000;slopebetarange=0:.50:10;


APmusclegoalbound=0.04;%NOISE SOURCE %@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
MLmusclebound=0.03;%NOISE SOURCE %@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
for iterrun=1:iterend
    iterrun               
            ...
            a=accln_Per_rotation_Coriolis_on(rcomo,vo ,ank2ank,swm,c,mub,flag0,1);
            disply=0;
            k1 = h *a;
            l1 = h *vo;
            k2 = h *accln_Per_rotation_Coriolis_on( rcomo+ l1./2, vo + k1./2,ank2ank,swm,c,mub,flag0,2);
            l2 = h *(vo + k1./2 );
            k3 = h *accln_Per_rotation_Coriolis_on( rcomo+ l2./2, vo + k2./2,ank2ank,swm,c,mub,flag0,3);
            l3 = h *(vo + k2./2 );
            ...
            k4 = h *accln_Per_rotation_Coriolis_on( rcomo+ l3, vo + k3,ank2ank,swm,c,mub,flag0,4);
            disply2=0;
            l4 = h *(vo + k3 );
    ...
    if length(slopetaurange)>1
        ...
        zlim([0 20])
        zlabel('T')
        if ispc set(gcf,'position',[1306 509 560 420]);end

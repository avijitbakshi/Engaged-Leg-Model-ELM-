...
brake=0;
            ...
            a=accln__FB_1g(rcomo,vo ,ank2ank,swm,c,mub,flag0,1);
            disply=0;
            k1 = h *a;
            l1 = h *vo;
            k2 = h *accln__FB_1g( rcomo+ l1./2, vo + k1./2,ank2ank,swm,c,mub,flag0,2);
            l2 = h *(vo + k1./2 );
            k3 = h *accln__FB_1g( rcomo+ l2./2, vo + k2./2,ank2ank,swm,c,mub,flag0,3);
            l3 = h *(vo + k2./2 );
            ...
            k4 = h *accln__FB_1g(rcomo+ l3, vo + k3,ank2ank,swm,c,mub,flag0,4);
            disply2=0;
            l4 = h *(vo + k3 );
